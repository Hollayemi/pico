...
const SlideDisplay = ({ noContent, pageTitle }) => {
    ...
    return (
        <div className="relative w-full h-[340px] overflow-hidden mb-10">
            ...
            {!noContent && <div className="relative z-10 flex items-center justify-center h-full">
                <div className="text-center text-white px-6 max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        ...
                        <Button title="Learn More" variant="outline" className="border-white py-3 w-44 !rounded-full text-white hover:text-black" />
            ...
            <div className="absolute top-4 right-4 z-20">
                <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${autoPlay
