  ...
  const navItems = [
    {
      ...
      dropdown: [
        {
          label: "Welcome From The Head Of School",
            ...
            <div className="flex items-center  justify-between">
              ...
              <nav className="hidden lg:flex items-center space-x-5 mr-5">
                {navItems.map((item) => (
                  <div
                    key={item.id}
                    className="relative md:static group"
                    ref={menuRef}
                  >
                    <div
                    ...
                    {item.dropdown && activeDropdown === item.id && (
                      <div
                        ref={clickOutRef}
                        className="absolute w-40 md:w-[90vw] flex items-start  h-fit md:h-80 top-full !left-0 mt-2 md:mt-4  bg-white rounded-md shadow-lg border md:border-none py-5 md:py-0 border-gray-200  "
                      >
