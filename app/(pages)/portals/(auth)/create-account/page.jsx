                ...
                <div className="bg-white rounded-2xl md:shadow-2xl px-4 md:p-8 backdrop-blur-sm">
                    ...
                    <div className="space-y-5 md:space-y-4">
                        ...
                        <button
                            ...
                            className="w-full bg-[#79A637] text-white py-2.5 px-4 rounded-lg font-semibold hover:bg-brand-700 focus:ring-4 focus:ring-green-200 transition-all duration-200 transform hover:scale-[1.02]"
                        >
